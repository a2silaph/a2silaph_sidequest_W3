...
function drawInstr() {
  ...
  const lines =
    "Each page displays a specific scenario. Press the button of your choice.\n" +
    "The buttons you press leads to different outcomes.\n" +
    "Press B to return to the start screen.";
